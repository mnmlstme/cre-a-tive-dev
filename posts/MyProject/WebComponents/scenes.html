                ...
                <kram-scene scene="1"><hello-world></hello-world>
</kram-scene>
<kram-scene scene="2"><hello-world> web components </hello-world>
</kram-scene>
<kram-scene scene="3"><hello-style> component style </hello-style>

<h1>This &lt;H1&gt; has no style</h1>
</kram-scene>
<kram-scene scene="4"><greet-world>
  <span slot="greeting">Greetings</span>
  <span slot="recipient">earthlings</span>
</greet-world>
</kram-scene>
<kram-scene scene="5"><arrow-button></arrow-button>
<arrow-button heading="90deg"></arrow-button>
<arrow-button heading="180deg"></arrow-button>
<arrow-button heading="-90deg"></arrow-button>
<arrow-button heading="45deg"></arrow-button>
</kram-scene>
<kram-scene scene="6"><section>
  <nav class="menu-bar">
    <dropdown-menu>
      File
      <ul slot="menu">
...
<kram-scene scene="10"><format-data name="count">The count is {count}.</format-data>
